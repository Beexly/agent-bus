...
Screen read after that, broker not named on the page: Total Value $100.01, today's change $0 (0.00%), priced as of 03:02 ET on 2026-09-24. Cash, no position. A fresh read of the connected feed still shows WellsTrade ...7767 at $0.01, so this $100.01 is not that brokerage record. It is the $100 seed at SoFi or Robinhood, or a Wells page the feed has not caught. At a 4.07% discount rate, $100.01 accretes about $0.01 a calendar day. It cannot buy one share of SPY or QQQ, and it cannot fund the 10-wide vertical. No order.
